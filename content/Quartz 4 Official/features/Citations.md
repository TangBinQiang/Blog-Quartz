...
Citation parsing is a functionality of the [[Quartz 4 Official/plugins/Citations|Citation]] plugin. **This plugin is not enabled by default**. See the plugin page for customization options.
