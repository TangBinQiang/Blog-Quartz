...
>>[!TODO]- 第一步：创建文章加密组件
>> [!TODO]- 01创建密码门控组件主文件
>>```diff title="quartz\components\PasswordGate.tsx"
...
>
>>> [!TODO]- 02创建密码门控组件样式文件
>>>```diff title="\quartz\components\styles\passwordGate.scss"
...
>>
>>> [!BUG]- 03创建客户端脚本文件
>>>```diff title="\quartz\components\scripts\passwordGate.inline.ts"
