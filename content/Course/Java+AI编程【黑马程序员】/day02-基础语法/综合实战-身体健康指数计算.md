...
> [!TIP]- Code
> ```java
> package com.test.day02.project;
> 
> import java.util.Scanner;
> 
> public class Calc_Health {
>     public static void main(String[] args) {
>         Scanner sc = new Scanner(System.in);
>         System.out.println("请输入你的你年龄:");
>         int age = sc.nextInt();
...
>     
>     //计算BMR
>     public static void CalcBMR(int age, String sex, double weight, double height) {
>         double BMR = 0;
>         if (sex.equals("男")) {
